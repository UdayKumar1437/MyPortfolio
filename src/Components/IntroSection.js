  ...
  return (
    <div className="flex pt-[100px] w-full bg-[#FFF3EA] iPhoneSE:flex-col-reverse laptop:flex-row pb-[50px] laptop:pb-[0px] gap-0 iPhoneSE:gap-[20px] laptop:gap-0">
      <div className="w-1/2 iPhoneSE:w-full flex flex-col justify-center gap-[15px] laptop:w-1/2 text-left pl-[5%]">
        ...
        <h1 className="font-medium text-4xl ">Hi 👋 I’m Uday Kumar Solving</h1>
        <TypeAnimation
          className="text-[#FA6C2C] font-bold text-5xl"
          sequence={[
          ...
          repeat={Infinity}
        />
        <h1 className="font-medium text-4xl">through design</h1>
        <p className="text-[#72687B]">
        I'm a React Frontend Developer hailing from the beautiful state of Andhra Pradesh, India. Currently, I'm working as a Software Engineer at Heeddata, where I've been refining my skills and making waves in the tech world for the past 1.5 years.
        </p>
        <div>
          <h1 className="mb-[10px] font-medium">FIND WITH ME</h1>
          <div className="flex gap-[10px]">
            <div className="rounded-lg bg-[#FA6C2C] hover:bg-[#FFFFFF]">
              <a href="https://www.facebook.com/profile.php?id=100012051373080" target="_blank"><IconButton
            ...
            <div className="rounded-lg bg-[#FA6C2C] hover:bg-[#FFFFFF]">
              <a href="https://twitter.com/uday9143" target="_blank"><IconButton>
                <XIcon
                  sx={{ color: "white", ":hover": { color: "#FA6C2C" } }}
                />
              </IconButton></a>
            ...
            <div className="rounded-lg bg-[#FA6C2C] hover:bg-[#FFFFFF]">
              <a href="https://www.linkedin.com/in/uday-kumar-%F0%9F%9A%80-a8b535224/" target="_blank">
              <IconButton>
                <LinkedInIcon
                  sx={{ color: "white", ":hover": { color: "#FA6C2C" } }}
                />
      ...
      <div className="w-1/2 iPhoneSE:w-full laptop:w-1/2 flex justify-center">
        ...
        <div className="bg-[#FBE3D2] rounded-lg relative">
          ...
          <div className="absolute animate-scale-up bg-white rounded-full h-[60px] flex justify-center items-center w-[60px] bottom-0 left-[50%] z-10">
            <img className="h-[20px]" src={tailwindCssLogo} />
          </div>
          <img
            alt="profile"
