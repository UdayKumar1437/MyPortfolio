  ...
  return (
    <div className="flex pt-[100px] w-full bg-[#FFF3EA] iPhoneSE:flex-col-reverse laptop:flex-row pb-[50px] laptop:pb-[0px] gap-0 iPhoneSE:gap-[20px] laptop:gap-0">
      <div className="w-1/2 iPhoneSE:w-full flex flex-col justify-center gap-[15px] laptop:w-1/2 text-left pl-[5%]">
        ...
        <h1 className="font-medium text-4xl font-Poppins ">Hi 👋 I’m Uday Kumar Solving</h1>
        <TypeAnimation
        ...
        <div>
          ...
          <div className="flex gap-[10px]">
            <div className="rounded-lg bg-[#FA6C2C] hover:bg-[#FFFFFF]">
              <a rel="noreferrer" href="https://www.facebook.com/profile.php?id=100012051373080" target="_blank"><IconButton
            ...
            <div className="rounded-lg bg-[#FA6C2C] hover:bg-[#FFFFFF]">
              <a rel="noreferrer" href="https://twitter.com/uday9143" target="_blank"><IconButton>
                <XIcon
                  sx={{ color: "white", ":hover": { color: "#FA6C2C" } }}
                />
              </IconButton></a>
            ...
            <div className="rounded-lg bg-[#FA6C2C] hover:bg-[#FFFFFF]">
              <a rel="noreferrer" href="https://www.linkedin.com/in/uday-kumar-%F0%9F%9A%80-a8b535224/" target="_blank">
              <IconButton>
                <LinkedInIcon
                  sx={{ color: "white", ":hover": { color: "#FA6C2C" } }}
                />
